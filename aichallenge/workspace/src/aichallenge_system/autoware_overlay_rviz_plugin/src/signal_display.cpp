...
void SignalDisplay::onInitialize()
{
  ...
  speed_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>(
    "Speed Topic", "/vehicle/status/velocity_status", "autoware_auto_vehicle_msgs/msg/VelocityReport",
  ...
  steering_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>(
    "Steering Topic", "/vehicle/status/steering_status", "autoware_auto_vehicle_msgs/msg/SteeringReport",
...
void SignalDisplay::topic_updated_gear()
{
  ...
  gear_sub_ =
    rviz_ros_node->get_raw_node()->create_subscription<autoware_auto_vehicle_msgs::msg::GearReport>(
      ...
      [this](const autoware_auto_vehicle_msgs::msg::GearReport::SharedPtr msg) { updateGearData(msg); });
}
...
void SignalDisplay::topic_updated_steering()
{
  ...
  auto rviz_ros_node = context_->getRosNodeAbstraction().lock();
  steering_sub_ =
    rviz_ros_node->get_raw_node()->create_subscription<autoware_auto_vehicle_msgs::msg::SteeringReport>(
...
void SignalDisplay::topic_updated_speed()
{
  ...
  auto rviz_ros_node = context_->getRosNodeAbstraction().lock();
  speed_sub_ =
    rviz_ros_node->get_raw_node()->create_subscription<autoware_auto_vehicle_msgs::msg::VelocityReport>(
...
void SignalDisplay::topic_updated_traffic()
{
  ...
  traffic_sub_ = rviz_ros_node->get_raw_node()
                   ->create_subscription<autoware_perception_msgs::msg::TrafficLightElement>(
